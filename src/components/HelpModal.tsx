  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-ner-black/75 backdrop-blur-sm animate-fade-in">
      <div className="bg-ner-offwhite border-2 border-ner-black rounded-3xl p-6 sm:p-8 max-w-lg w-full shadow-2xl relative">
        ...
        <p className="text-xs sm:text-sm text-ner-black/70 mb-6 leading-relaxed">
          {t.helpModalDesc}
        </p>

        {feedbackMessage ? (
          <div className="p-5 rounded-2xl bg-emerald-100 border border-ner-sage text-ner-sage flex items-center gap-3 animate-fade-in my-6">
        ...
        <div className="mt-6 pt-4 border-t border-ner-border/70 text-center">
