...
export const PatientProfilePage: React.FC = () => {
  ...
  const { language, textSize, contrast, motion, t } = useAccessibility();
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-sm text-ner-black/60 flex items-center gap-1.5 mt-1">
                ...
                {activePatient.location}, {activePatient.state}
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="frost-card rounded-3xl p-6 sm:p-8">
          ...
          <div className="space-y-3 text-sm">
            <div>
              <span className="text-xs font-mono text-ner-black/40 uppercase block">{t.roleCaregiverTitle}</span>
              <span className="font-bold text-ner-black">
                {activePatient.primaryCaregiver.name} ({activePatient.primaryCaregiver.relation})
              </span>
            </div>
            <div>
              <span className="text-xs font-mono text-ner-black/40 uppercase block">{t.caregiverQuickCall}</span>
              <span className="font-mono text-ner-black font-semibold">
                {activePatient.primaryCaregiver.phone}
              </span>
            </div>
            <div>
              <span className="text-xs font-mono text-ner-black/40 uppercase block">{t.caregiverPatientStatus}</span>
              <span className="text-ner-black/70">{t.caregiverSubtitle}</span>
            </div>
          </div>
        </div>
        ...
        <div className="frost-card rounded-3xl p-6 sm:p-8">
          ...
          <div className="space-y-3 text-sm">
            <div>
              <span className="text-xs font-mono text-ner-black/40 uppercase block">{t.doctorTitle}</span>
              <span className="font-bold text-ner-black">
            ...
            <div>
              <span className="text-xs font-mono text-ner-black/40 uppercase block">{t.doctorSubtitle}</span>
        ...
        <div className="frost-card rounded-3xl p-6 sm:p-8">
          ...
          <div className="space-y-3 text-sm">
            <div>
              <span className="text-xs font-mono text-ner-black/40 uppercase block">{t.languageSettingDesc}</span>
              <span className="font-bold text-ner-black uppercase">{language}</span>
            </div>
            <div>
              <span className="text-xs font-mono text-ner-black/40 uppercase block">{t.nerTitle}</span>
              <span className="text-ner-black/70">{t.nerDescription}</span>
            </div>
          </div>
        </div>
